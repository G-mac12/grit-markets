...
export const FAQ: FaqEntry[] = [
  ...
  },
  {
    ...
    answerShort:
      "Grit Markets is sold as a monthly software subscription — Standard at £29/month with one MT5 account licence, or Premium at £49/month with up to three accounts, advanced analytics and priority support. The first month is free on both plans, on a demo or live account, and every safety feature ships in every tier. The EA validates your licence key when it runs, and you can cancel at any time, effective at the end of the current billing period.",
    answerLong: [
