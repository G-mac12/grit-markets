  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        text: "Independent of profile choice, the engine pauses around high-impact USD, EUR and CAD news — 90 minutes after rate decisions and NFP, 60 after CPI and GDP, 45 after other high-impact events, plus 10 minutes before any of them — and enforces its calendar protections: a Friday cutoff before the weekend close, a Monday warm-up, a rollover blackout around broker midnight, and a holiday block over Christmas and New Year. These are part of the engine, not options to configure away. Remember their limit: filters cover scheduled events, and the most damaging moves are often unscheduled.",
      },
      {
